...
class Tests():
  ...
  def test_request_zpool_sysfs_b_online_with_all_dependencies(self):
    ...
    result = operations.request(Request.ONLINE, ZFSBackingBlockDevice, pool="zmirror-sysfs", dev="zmirror-sysfs-b", all_dependencies=True)
  ...
  def test_request_scrub_zmirror_sysfs(self):
    ...
    def possibly_scrub(entity):
      if isinstance(entity, ZFSBackingBlockDevice) and entity.pool == "zmirror-sysfs":
