...
zfs create zmirror/bak-b -V 800MiB
...
parted /dev/zvol/zmirror/bak-b -- mklabel gpt
parted /dev/zvol/zmirror/bak-b -- mkpart zmirror-bak-b 1MiB 100%
...
cryptsetup luksFormat /dev/disk/by-partlabel/zmirror-bak-b --key-file ./zmirror-key --batch-mode
...
cryptsetup open /dev/disk/by-partlabel/zmirror-bak-b zmirror-bak-b --key-file ./zmirror-key
...
zpool create zmirror-bak-b -R /tmp/zmirror/zmirror-bak-b /dev/mapper/zmirror-bak-b -o autotrim=on -O acltype=posix -O atime=off -O canmount=off -O dnodesize=auto -O utf8only=on -O xattr=sa -O mountpoint=none -f
...
### create zpool 
zpool create zmirror-sysfs -R /tmp/zmirror/zmirror-sysfs mirror /dev/mapper/zmirror-sysfs-a /dev/mapper/zmirror-sysfs-b /dev/zvol/zmirror-bak-a/sysfs /dev/zvol/zmirror-bak-b/sysfs -o autotrim=on -O acltype=posix -O atime=off -O canmount=off -O dnodesize=auto -O utf8only=on -O xattr=sa -O mountpoint=none -f
zpool create zmirror-big -R /tmp/zmirror/zmirror-big mirror /dev/mapper/zmirror-big-a /dev/mapper/zmirror-big-b /dev/zvol/zmirror-bak-a/big /dev/zvol/zmirror-bak-b/big -o autotrim=on -O acltype=posix -O atime=off -O canmount=off -O dnodesize=auto -O utf8only=on -O xattr=sa -O mountpoint=none -f